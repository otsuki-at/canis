...
class Feature:
    # def __init__(self, logfile_name):
        ...
        # self.lastdate = None
        # self.fd = codecs.open(self.filename, 'r', 'utf-8', 'ignore')
        # self.logs = self.fd.read().splitlines()
...
def main():
    ...
    for file_name in args[1:]:
        ...
        heatmap.set_logfile(file_name)
        matrix = heatmap.separate_by_time(10)
        aggregates = heatmap.aggregate_filetype(matrix)
        heatmap.show(aggregates[1:])
